...
namespace Roborally.Communication.ServerInterfaces
{
    ...
    public interface IMainService
    {
        ...
        void BoardActions(IList<IGameRobot> robots);
        ...
        void MoveRobots(int robotId, IList<IGameRobot> robots);
        ...
        void SetupRegisters(IList<IRegister> registers);
